                            ...
                            <div class="cloth-details-size">
                                ...
                                <h3 class="price-detail">
                                    @if ($product->sale_price)
                                        ...
                                        <span>{{$product->calculatePercentageOff()}}% off</span>
                                    @else
                    ...
                    <div>
                        <div class="product-box">
                            <div class="img-wrapper">
                                <div class="front">
                                    <a href="{{route('shop.product.details', ['slug'=>$r_product->slug])}}">
                                        <img src="{{asset('/assets/images/fashion/product/front')}}/{{$r_product->image}}"
                                            class="bg-img blur-up lazyload" alt="">
                                    </a>
                                </div>
                                <div class="back">
                                    <a href="{{route('shop.product.details', ['slug'=>$r_product->slug])}}">
                                        <img src="{{asset('/assets/images/fashion/product/back')}}/{{$r_product->image}}"
                                            class="bg-img blur-up lazyload" alt="">
                                    </a>
                                </div>
                                <div class="cart-wrap">
                            ...
                            <div class="product-details">
                                ...
                                <div class="main-price">
                                    <a href="{{route('shop.product.details', ['slug'=>$r_product->slug])}}" class="font-default">
                                        <h5>{{$r_product->name}}</h5>
                                    </a>
                                    <div class="listing-content">
                                        <span class="font-light">{{$product->category->name}}</span>
                                        <p class="font-light">{{$r_product->short_description}}</p>
                                    </div>
                                    <h3 class="theme-color">@if($r_product->sale_price) &#8358;{{$r_product->sale_price}} @else &#8358;{{$r_product->regular_price}} @endif</h3>
