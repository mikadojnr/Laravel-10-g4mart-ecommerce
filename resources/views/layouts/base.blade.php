                                                    ...
                                                    @auth
                                                        @if (Auth::user()->utype === 'ADM')
                                                            <li>
                                                                ...
                                                                <a href="{{ route('admin.customers')}}" class="d-block">All Customers</a>
                                                                <a href="{{ route('admin.orders')}}" class="d-block">All Orders</a>
                                                            </li>
                                                        @else
                                                            <li>
                    ...
                    <div class="col-xl-3 col-lg-4 col-md-6">
                        <div class="footer-contact">
                            ...
                            <ul class="contact-lists" style="clear:both;">
                                <li>
                                    <span><b>phone:</b> <span class="font-light"> +234 812 345 6789</span></span>
                                </li>
                                <li>
                                    <span><b>Address:</b><span class="font-light"> FU Otuoke, Ogbia, Bayelsa, NG</span></span>
                                </li>
                                <li>
                                    <span><b>Email:</b><span class="font-light"> contact@g4mart.com</span></span>
                                </li>
                            </ul>
                        </div>
                    </div>
                            ...
                            <div class="footer-content">
                                <ul>
                                    ...
                                    @else
                                        ...
                                        <li>
                                            <a href="{{ route('login')}}" class="font-dark">Login</a>
                                        </li>
                                        <li>
                                            <a href="{{route('register')}}" class="font-dark">Register</a>
                                        </li>
                                    @endauth
        ...
        <div class="sub-footer">
            <div class="container">
                <div class="row gy-3">
                    ...
                    <div class="col-md-6">
                        <p class="mb-0 font-dark">© 2023, G4 Mart.</p>
                    </div>
                </div>
            </div>
        </div>
